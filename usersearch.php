      ...
      <div class="d-flex justify-content-center search">
        ...
        <?php
         ...
         if(isset($_POST['Search'])){ ?>
                      ...
                      <td>
                        <video style="height: 200px; width: 350px" src="video/<?php echo $row['video']; ?>" autoplay muted loop disablePictureInPicture></video>
                        <p>Comparison between other's flight suggestions and<br> recommendations by our website to reach your <br> location From: <?php echo $row['Departure']; ?> to <?php echo $row['Arrival']; ?></p>
                      </td>
...
<div id="popup">
    <div class="popupcontrols">
        <span id="popupclose" style="font-size: 30px;">✖</span>
    </div>
